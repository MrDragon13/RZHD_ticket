...
- **Скоринг и фильтрация поездов** — детерминированные правила поверх данных РЖД; объяснимость для аудита и жюри.
...
Так достигается позиционирование: **мы не прикрутили чат к справочнику — мы спроектировали киоск, где умный слой проходит через диалог, карту, рекомендации, сравнение, поддержку и голосовые сценарии**, а всё остальное сделано **умным, предсказуемым и проверяемым** — это и есть выгодное отличие для конкурса и для рассказа инвестору или заказчику.
...
Для олимпиады и ревью зафиксирован **минимальный автоматический контур качества**, который можно показать как «есть тесты, они зелёные»:
