...
| **Сравнение поездов** | По двум выбранным поездам из списка — структурированный текст (`POST /api/compare-trains`: время, цена, комфорт, компромиссы), озвучка ассистентом и резерв без DeepSeek. |
