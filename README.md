...
- после выбора языка — **демо-вход по телефону и SMS** (имитация, без хранения персональных данных на сервере); условные ФИО и документ отображаются на демо-билете; при **отсутствии действий ~120 с** (≈2 мин.) — предупреждение за **5 с** и возврат на язык с очисткой диалога; отсчёт **приостанавливается** на время ожидания ответа API; кнопка **«Выход»** в шапке — принудительный возврат на старт;
...
14. Если пользователь не трогает терминал **около двух минут**, появляется предупреждение и интерфейс возвращается к **выбору языка**, контекст диалога очищается (удобно для демонстрации и публичного киоска).
