...
14. Пользователь подтверждает выбор мест.
15. Система имитирует оформление, показывает демо-билет с QR-зоной и короткую микро-анимацию успеха (при системной настройке «меньше движения» — только без звука и без заметной анимации).
