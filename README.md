...
Поиск поездов через RZD Data Adapter. В MVP используется demo-база.
...
Сейчас реализован стабильный **Demo Mode**:
...
**Live Mode** заложен архитектурно через `RzdDataAdapter`. В будущем туда можно добавить официальный источник данных или аккуратный live-парсер без обхода капчи, без авторизации и без обработки персональных данных.
