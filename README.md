...
- после выбора языка — **демо-вход по телефону и SMS** (имитация, без хранения персональных данных на сервере); условные ФИО и документ отображаются на демо-билете; при **отсутствии действий ~120 с** (≈2 мин.) — предупреждение за **10 с** и возврат на язык с очисткой диалога; отсчёт **приостанавливается** на время ожидания ответа API; кнопка **«Выход»** в шапке — принудительный возврат на старт;
