...
// По умолчанию frontend обращается к 8000 порту того же хоста: это удобно и
// локально, и на VDS, где FastAPI опубликован рядом со статическим интерфейсом.
const API_BASE_URL =
  window.PATH_API_BASE_URL || `${window.location.protocol}//${window.location.hostname}:8000`;
